...
CREATE INDEX idx_pd_specs_warranty ON product_details ((CAST(JSON_UNQUOTE(JSON_EXTRACT(specs, '$.warranty')) AS CHAR(32))));
...
CREATE FULLTEXT INDEX idx_reviews_comment_ft ON reviews(comment);
